...
VALUES(1, 'Olayinka', 'Arimoro', 'aoidatsci8mentoring@gmail.com', 0),
      (2, 'Akshay', 'Singh', 'ddghdghdghdghgd@yahoo.uk',2),
	   (3, 'Ayamikum','isijgh', 'sduhfjkhfj@gmail.com',1),
	   (4, 'mukesh', 'singh', 'gddghgd@hotmail.com',0 ),
	   (5, 'priya','singh','jdjdhfdhd@orkut.co', 5);

-- Insert five (5) records into the items table
INSERT INTO items
VALUES ('A11','Soap', 10.20, 1, 'Company A'),
       ('A12', 'lamp', 15.10 , 1, 'Company A'),
	   ('B11', 'Desk', 50.2, 2, 'Company B'),
	   ('B12', 'Chair', 150.2, 2, 'Company B'),
	   ('C11', 'Bicycle', 35.59, 3, 'Company C');
...
headqu8arters_phone_number VARCHAR(255)
);
...
SELECT * FROM sales; ---This will copy all data, no need to write
...
INSERT INTO customers_dup
VALUES (6, 'Isreal', 'hawkins', 'hawkins.yahoo.com',2, 'M'),
       (7, 'Shrawan', 'Kumar', 'shrawank@gmail.com',11, 'M');
...
-- Rename the unit_price_usd column in items table to item_price
ALTER TABLE items
...
-- DROP the customers_dup table (it will delete all data including table name also)
DROP TABLE customers_dup;
--Retrive
SELECT * FROM customers_dup;

-- TRUNCATE the sales_data table (it will delete all data only not table name)
...
-- If we dont use 'where' in delete, what will happen?
